 ...
 */}
      <div class="brand_ mt-5">
        ...
        <div class="brand_bg">
          <div class="container">
            <h1 class="related-head">Sony</h1>
            <div class="row">
              {$sony.slice(0, state.itemsToShow).map((val, i) => {
                return (
                  <div
                    key={i}
              ...
              <div class="col-md-12">
                ...
                <a class="read-more" onClick={showMore}>
                  {state.expanded ? <div>Show less</div> : <div>Show more</div>}
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="brand_bg">
          <div class="container" id="Sharp">
            <h1 class="related-head">Sharp</h1>
            <div class="row">
              {$sharp.slice(0, state.itemsToShow).map((val, i) => {
                return (
                  <div
                    key={i}
                    class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin"
        ...
        <div class="brand_bg">
          <div class="container">
            <h1 class="related-head">Arrows</h1>
            <div class="row">
              {$arrows.slice(0, state.itemsToShow).map((val, i) => {
                return (
                  <div
                    key={i}
                    class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin"
        ...
        <div class="brand_bg">
          <div class="container">
            <h1 class="related-head">Kyocera</h1>
            <div class="row">
              {$kyocera.slice(0, state.itemsToShow).map((val, i) => {
                return (
                  <div
                    key={i}
                    class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin"
        ...
        <div class="brand_bg">
          <div class="container">
            <h1 class="related-head">Other</h1>
            <div class="row">
              {$google.slice(0, state.itemsToShow).map((val, i) => {
                return (
                  <div
                    key={i}
                    class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin"
